          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="relative w-full h-0 pb-56">
              <video className="absolute top-0 left-0 w-full h-full border-4 border-gray-300" controls
                src="https://res.cloudinary.com/ddei3mzex/video/upload/v1729073232/How_To_Become_A_Back-End_Web_Developer_sq9r2i.mp4">
              </video>
            </div>
          </div>
        </div>
  ...
  <div className="container mx-auto px-6 lg:px-12 text-center space-y-16">
    ...
    <div>
      ...
      <p className="text-lg md:text-xl text-gray-700">
        Our Backend Programming Bootcamp spans 12 weeks of immersive, hands-on learning designed to build your backend expertise.
      </p>
    </div>
    ...
    <div>
      ...
      <NavLink to="/apply" className="bg-blue-600 text-white py-4 px-10 rounded-full shadow-lg hover:bg-blue-700 transition duration-300 text-lg md:text-xl">
        Apply Now
      </NavLink>
    </div>
  </div>
