    ...
    <nav className="bg-gray-800 opacity-100 shadow-md fixed w-full z-20 top-0 left-0">
      <div className="container mx-auto flex items-center justify-between p-4">
        ...
        <div className="flex items-center cursor-pointer">
          <img src={'/'} alt="Logo" className="h-10 w-[60px]" />
        </div>
      ...
      >
        <div className="p-4">
          <Link to={'/'}>
            <img src="https://res.cloudinary.com/ddei3mzex/image/upload/v1729158010/crest_x1gutu.jpg" alt="Logo" className="h-10 w-auto mb-4" />
          </Link>
          <ul>
            {/* Home */}
            <li>
