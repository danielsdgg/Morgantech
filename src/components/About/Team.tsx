                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="col-span-3 md:col-span-1 pt-9">
                        <div className="bg-gray-100 rounded-lg p-8 transition-colors duration-300 hover:bg-blue-500 hover:text-white">
                            ...
                            <h3 className="text-xl font-semibold">Matthew Murdock</h3>
                            <div className="mb-4">
                                <p className="text-gray-600">Marketing manager</p>
                            </div>
                            <p className="text-black">Murdock first fell in love with digital marketing at the university. He loves to learn, and looks forward to being part of this new exciting industry for many years.</p>
                            <ul className="flex justify-center mt-6">
                                <li className="mx-2">
                                <a href="http://www.twitter.com" > <FaTwitterSquare size={30} /> </a>
                                </li>
