    ...
    <div className="flex justify-center items-center">
      <form className="w-full bg-white p-8 rounded-lg shadow-lg">
        <div className="pb-8 text-center">
          ...
          <p className="text-gray-600">To contact us, please fill out the form below or send an email to <a href="mailto:morgantechnical72@gmail.com" className="text-blue-500">morgantechnical72@gmail.com</a>.</p>
        </div>
